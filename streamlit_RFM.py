...
if choice == 'Business Objective':   
    ...
    if type=="Input_new_customer":
        st.session_state.email1 = float(st.number_input(label="Input your Recency (>=0): ", value=st.session_state.email1))
        st.session_state.email2 = float(st.number_input(label="Input your Recency (>=0): ", value=st.session_state.email2))
        st.session_state.email3 = float(st.number_input(label="Input your Recency (>=0): ", value=st.session_state.email3))
